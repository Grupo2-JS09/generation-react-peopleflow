...
//       }
//       update(params: { dt: number; isBounce: boolean; BFECC: boolean }): void {
...
//         // Double check renderer after potential init
//         if (!Common.renderer || !Common.renderer.domElement.parentNode) {
...
//       }
//       dispose() {
//         // Always dispose, regardless of running state
//         this.pause();
...
//               this.output.scene.traverse((object) => {
...
//               });
//             }
//             // Dispose FBOs and other resources
//             if (this.output.simulation) {
//               Object.values(this.output.simulation.fbos).forEach(fbo => {
//                 if (fbo) {
//                   fbo.dispose();
//                 }
//               });
...
//       if (webglRef.current && !webglRef.current.running && isVisibleRef.current) {
//         console.log('Restarting WebGL...');
//         webglRef.current.start();
//       }
//     }, 1000);

//     // Store interval reference for cleanup
//     const intervalRef = { current: checkInterval };
...
//     return () => {
//       // Store mounting state before cleanup
...
//           intersectionObserverRef.current.disconnect();
//         } catch (err) {
//           console.warn('Error disconnecting intersection observer:', err);
//         }
//         intersectionObserverRef.current = null;
//       }
...
//           webglRef.current = null;
//         } else {
//           // Just pause if we're still mounted (e.g., for prop changes)
//           webglRef.current.pause();
//         }
//       }
//     };
